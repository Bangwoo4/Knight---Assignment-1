...
*/
		...
		for (int i = 0; i < n2; i++)
		{
			if (arrFileMushGhost2[i] == max2_3x)
			{ //trường hợp có 2 số đầu giống nhau => tìm số đầu tiên
				max2_3i = i;
				break;
			}
		}
		...
		if (thuaShaman > 0)
		{
			thuaShaman = thuaShaman + 1;
		}
		//Xử lí 6 7
		//========================
		if (thuaVajsh > 0)
		{
			thuaVajsh = thuaVajsh + 1;
		}
		if (thuaVajsh == 5)
		{
			thuaVajsh = 0;
		...
		if ((thuaShaman != 0) && (thuaShaman != 4) && (Koopa[i + 1] != -1))
		{
			...
			} //bỏ qua nếu vẫn còn là tí hon hoặc ếch
		}
		...
		{
			if ((arr_kn[i - 1].level > levelO) && (arr_kn[i - 1].level < 10))
			{
				arr_kn[i].level = arr_kn[i - 1].level + 1;
			}
			...
			if (arr_kn[i - 1].level < levelO)
			{
				...
				else if (arr_kn[i - 1].remedy < 1)
				{
					if ((thuaShaman == 0) && (thuaVajsh == 0))
					{
						...
						} //nếu thua và không có remedy
						if ((arr_kn[i - 1].HP > 0) && (arr_kn[i - 1].HP < 5))
						{
							arr_kn[i].HP = 1;
						}
						thuaShaman = 1;
		...
		else if ((Koopa[i] == 7) && (thuaVajsh == 0))
		{
			...
			{
				if (arr_kn[i - 1].maidenkiss >= 1)
				{
					arr_kn[i].maidenkiss = arr_kn[i - 1].maidenkiss - 1; //biến thành ếch và có maidenkiss
				}
		...
		if (Koopa[i] == 99)
		{
			...
			{ //Nếu thua Brơser, cout thông tin trước đó và rescue =0; break;
				if (thuaShaman == 4)
				{
					thuaShaman = 0;
					if (arr_kn[i].HP > 0)
		...
		if (Koopa[i] == 15 || Koopa[i] == 16 || Koopa[i] == 17)
		{
			...
			else if (Koopa[i] == 16)
			{
				...
				if (arr_kn[i].maidenkiss > 99)
				{
					arr_kn[i].maidenkiss = 99;
				}
			}
			else if (Koopa[i] == 17)
			{
				arr_kn[i].phoenixdown = arr_kn[i - 1].phoenixdown + 1;
				if (arr_kn[i].phoenixdown > 99)
				{
					arr_kn[i].phoenixdown = 99;
				}
			}
			if ((thuaShaman != 0) && (arr_kn[i].remedy >= 1))
			{
				thuaShaman = 0;
				arr_kn[i].remedy = arr_kn[i].remedy - 1;
				arr_kn[i].HP = arr_kn[i].HP * 5;
			}
			if ((thuaVajsh != 0) && (arr_kn[i].maidenkiss >= 1))
			{
				thuaVajsh = 0;
				arr_kn[i].maidenkiss = arr_kn[i].maidenkiss - 1;
				for (int x = 0; x < 5; x++)
				{
					if (arr_kn[i - x].level != 1)
					{
						arr_kn[i].level = arr_kn[i - x].level;
						break;
					}
				}
			}
		...
		if (Koopa[i] == 18 && (checkk != 1) && (khongcout != 1))
		{
			display(arr_kn[i].HP, arr_kn[i].level, arr_kn[i].remedy, arr_kn[i].maidenkiss, arr_kn[i].phoenixdown, arr_kn[i].rescue);
			continue;
		}
		else if ((Koopa[i] == 18) && (checkk == 1))
		{
			...
			for (int m = 0; m < n9; m++)
			{
				...
				{
					if ((stringMerlin[m][o] == 'm') || (stringMerlin[m][o] == 'M'))
					{
						cao = 1;
						break;
					}
				...
				if (cao == 1)
				{
					for (int o = 0; o < stringMerlin[m].length(); o++)
					{
						if ((stringMerlin[m][o] == 'E') || (stringMerlin[m][o] == 'e'))
						{
							cao = 2;
							break;
						}
				...
				if (cao == 2)
				{
					for (int o = 0; o < stringMerlin[m].length(); o++)
					{
						if ((stringMerlin[m][o] == 'R') || (stringMerlin[m][o] == 'r'))
						{
							cao = 3;
							break;
						}
				...
				if (cao == 3)
				{
					for (int o = 0; o < stringMerlin[m].length(); o++)
					{
						if ((stringMerlin[m][o] == 'L') || (stringMerlin[m][o] == 'l'))
						{
							cao = 4;
							break;
						}
				...
				if (cao == 4)
				{
					for (int o = 0; o < stringMerlin[m].length(); o++)
					{
						if ((stringMerlin[m][o] == 'I') || (stringMerlin[m][o] == 'i'))
						{
							cao = 5;
							break;
						}
				...
				if (cao == 5)
				{
					for (int o = 0; o < stringMerlin[m].length(); o++)
					{
						if ((stringMerlin[m][o] == 'n') || (stringMerlin[m][o] == 'N'))
						{
							cao = 6;
							break;
						}
